...
class Theme {
  ...
  getArrayControl(config) {
    ...
    const deleteAllBtn =
      config.arrayDeleteAll === true
        ? this.getArrayBtnDeleteAll({ content: config.arrayDeleteAllContent })
        : null;
    const footerDeleteAllBtn =
      config.arrayFooterDeleteAll === true
        ? this.getArrayBtnDeleteAll({
            content: config.arrayFooterDeleteAllContent,
          })
        : null;
  ...
  getMultipleControl(config = {}) {
    ...
    const switcherType = knownSwitchers.includes(config.switcher)
      ? config.switcher
      : "select";
