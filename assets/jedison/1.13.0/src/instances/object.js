...
class InstanceObject extends Instance {
  prepare() {
    ...
    this.schemaAdditionalProperties = getSchemaAdditionalProperties(
      this.schema,
    );
  ...
  sortChildrenByPropertyOrder() {
    ...
    this.children = this.children.sort((a, b) => {
      ...
      const propertyOrderA = isParentMap && isNumber(parentOrderMap[keyA])
        ? parentOrderMap[keyA]
        : getSchemaXOption(a.schema, 'propertyOrder')
      const propertyOrderB = isParentMap && isNumber(parentOrderMap[keyB])
        ? parentOrderMap[keyB]
