...
class InstanceMultiple extends Instance {
  prepare() {
    ...
    this.schemas.forEach((schema) => {
      // FIX: Prevent cross-contamination of incompatible types in oneOf/anyOf sub-instances.
      // Avoids TypeError (string passed to object) and [object Object] UI glitch (object passed to string).
      const isCompatible =
        !isSet(this.value) ||
